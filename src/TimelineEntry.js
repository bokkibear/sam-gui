            ...
            <div style={ { flex: "1 1 0" } }>                                
                <h3 style={ { padding: 0 } }>
                    ...
                    <ul style={ { listStyleType: "none", display: "inline-block" } }>
                        {
                            tags.map( tag => <li style={ { display: "inline-block", backgroundColor: "#016", color: "#fff", borderRadius: "4px", padding: "2px 5px", fontSize: "70%", fontWeight: "bold", margin: "2px" } } key={ tag }>{ tag }</li> )
                        }
                    </ul>
                </h3>
                <div style={ { fontSize: "80%" } }>
                    ...
                    { 
                        alert === "minor" ? false : <span style={ LIGHT_STYLE }>{ source }</span>
                    }
                </div>
